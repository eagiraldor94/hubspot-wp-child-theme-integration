jQuery(document).ready(function($) {
	...
	jQuery('.wpcf7-submit').on('click',  function(event) {
		...
		var jackUrl1 = "/wp-content/themes/api-theme/Interaction/form_requests.php?queryType=agenda_reg&name="+name+"&surname="+surname+"&company="+company+"&email="+email+"&job="+job+"&country="+country+"&phone="+countryCode+" - "+phoneNumber+"&event="+event+"&eventCode="+eventCode+"&learn="+learn+"&message="+message;
		jQuery.ajax({
			url: jackUrl1,
			type: 'GET',
		})
